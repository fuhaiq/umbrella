...
public class NettyServiceType {
	
	public NettyServiceType(EventLoopGroup boss, EventLoopGroup worker, Class<? extends ServerChannel> channelClass) {
		this.boss = boss;
		this.worker = worker;
	...
	public static final class EPOLL extends NettyServiceType {
	...
	public static final class NIO extends NettyServiceType {
