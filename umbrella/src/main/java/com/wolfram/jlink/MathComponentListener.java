 ...
 * <PRE>
 *     userCode[theComponentEvent]</PRE>
 * 
...
public class MathComponentListener extends MathListener implements ComponentListener {
	 ...
	 * 
	 * @param ml The link to which computations will be sent when ComponentEvents arrive.
	 */
	 ...
	 * 
	 * @param handlers An array of {meth, func} pairs associating methods in the ComponentListener
	...
	public void componentHidden(ComponentEvent e) {
		callVoidMathHandler("componentHidden", new Object[]{e});
	}

	public void componentMoved(ComponentEvent e) {
		callVoidMathHandler("componentMoved", new Object[]{e});
	}

	public void componentResized(ComponentEvent e) {
		callVoidMathHandler("componentResized", new Object[]{e});
	}

	public void componentShown(ComponentEvent e) {
		callVoidMathHandler("componentShown", new Object[]{e});
	}
