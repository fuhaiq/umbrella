 ...
 * <PRE>
 *     userCode[theContainerEvent]</PRE>
 * 
...
public class MathContainerListener extends MathListener implements ContainerListener {
	 ...
	 * 
	 * @param ml The link to which computations will be sent when ContainerEvents arrive.
	 */
	 ...
	 * 
	 * @param handlers An array of {meth, func} pairs associating methods in the ContainerListener
	...
	public void componentAdded(ContainerEvent e) {
		callVoidMathHandler("componentAdded", new Object[]{e});
	}

	public void componentRemoved(ContainerEvent e) {
		callVoidMathHandler("componentRemoved", new Object[]{e});
	}
