...
public class ArrowArrowReader extends ArrowReader {
  ...
  public ArrowArrowReader(
      BufferAllocator allocator, NativeMemoryPool memoryPool, String uri, ScanOptions options) {
    super(allocator);
    this.datasetFactory =
        new FileSystemDatasetFactory(allocator, memoryPool, FileFormat.ARROW_IPC, uri);
