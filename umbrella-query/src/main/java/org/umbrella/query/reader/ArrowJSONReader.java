...
@Slf4j
public class ArrowJSONReader extends ArrowReader  {
    private final DatasetFactory datasetFactory;
    private final Dataset dataset;
    private final Scanner scanner;
    private final ArrowReader reader;

    public ArrowJSONReader(BufferAllocator allocator, NativeMemoryPool memoryPool, String uri) {
        this(allocator, memoryPool, uri, new ScanOptions.Builder(/*batchSize*/ 32768)
                .columns(Optional.empty())
                .build());
    }

    public ArrowJSONReader(BufferAllocator allocator, NativeMemoryPool memoryPool, String uri, ScanOptions options) {
        super(allocator);
