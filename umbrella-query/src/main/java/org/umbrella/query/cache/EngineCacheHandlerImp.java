...
/**
 * 参考: https://duckdb.org/faq.html#how-does-duckdb-handle-concurrency-within-a-single-process <br>
    ...
    client
        ...
        .connection(
            conn -> {
              ...
              try (reader;
                  var arrowStream = ArrowArrayStream.allocateNew(client.allocator())) {
